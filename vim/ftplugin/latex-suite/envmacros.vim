...
let s:figure = "\\begin{figure}[htbp]\<cr>\\centering\<cr>\\includegraphics[width=<+ratio+>\\textwidth]{<+pdf file+>}\<cr>\\begin{minipage}{0.9\\linewidth}\<cr>\\caption{\\protect .\\label{fig:<+label+>}}\<cr>\\end{minipage}\<cr>\\end{figure}<++>"
